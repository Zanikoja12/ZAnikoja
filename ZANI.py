...
\033[1;92m---------------------BRAND---------------------
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;96mHATERX MAKES ME FAMOUS ZAIN ..
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;91mDEVOLPER
                     ZANI KOJA
\033[1;94mFACEBOOK
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://www.facebook.com/zani/')
    else:
        print "\033[1;94mWrong Username"
        os.system('xdg-open https://www.facebook.com/zani.005/')
...
def Zeek():
    ...
    time.sleep(0.10)
    print '\x1b[1;92m[2] zani koja FB ACCOUNT'
    time.sleep(0.10)
    ...
    time.sleep(0.10)
    print '\x1b[1;91m[6] zani FACEBOOK'
    time.sleep(0.10)
